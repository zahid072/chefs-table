...
const Nav = () => {
  ...
  <div className="navbar-center hidden lg:flex">
    ...
    <div className="rounded-full flex items-center gap-2 bg-slate-200 w-24 md:w-[260px] p-3">
     <CiSearch className='size-6'/>
      <input type="text" placeholder="Search" className="rounded-full w-24 outline-none bg-transparent md:w-auto" />
    </div>
